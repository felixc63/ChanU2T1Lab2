public class ChatBot {
    ...
    // method that returns your height in feet
    public int tall(int heightInFeet){
        return heightInFeet;
    }

    // method that prints a reason for the bot's farewell
    public void end(){
        System.out.println("Seems like my battery is running low.");
    }
